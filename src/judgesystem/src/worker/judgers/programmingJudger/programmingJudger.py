...
class ProgrammingJudger(Judger):
    def __init__(self, t_tag, t_sandbox):
        ...
        self.m_checkers = {0:compileChecker.compileChecker.CompileChecker("compile check", t_sandbox),\
                           1:standardChecker.standardChecker.StandardChecker("standard tests", t_sandbox),\
